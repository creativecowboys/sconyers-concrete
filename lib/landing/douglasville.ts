...
export const douglasville: LandingPage = {
  ...
  whyUs: {
    tag: 'Why Sconyers',
    heading: 'Built Solid for Douglasville Businesses',
    pillars: [
      {
        num: '01',
        title: 'Quality First',
        body: 'We bring the materials, the expertise, and the hands-on oversight to Douglas County. No cut corners. Just concrete that holds up for decades.',
      },
      {
        num: '02',
  ...
  process: {
    tag: 'Our Process',
    heading: 'How a Douglasville project actually runs',
    steps: [
      {
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: 'Do you serve all of Douglas County?',
        answer: [
  ...
  contact: {
    ...
    submitLabel: 'Request My Douglasville Estimate',
